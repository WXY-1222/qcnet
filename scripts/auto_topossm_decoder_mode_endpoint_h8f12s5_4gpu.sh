...
# Short structural probe for the full-replacement TopoSSM decoder.
# Adds a mode-specific endpoint/proposal head on top of Seed49B best and stops
# early if the new proposal structure is clearly worse.
...
RUN_LOG="${RUN_LOG:-${LOG_DIR}/qcnet_topossm_decoder_mode_endpoint_h8_f12_s5_k6_4gpu_20260505.log}"
...
log "TopoSSM mode-endpoint supervisor started"
