...
# Corridor-aware scoring supervisor.
# Keep the proposal path free (goal MLP), and push corridor information into
# score / refinement / distillation instead of hard-binding the goal to map nodes.
...
SAVE_ROOT="${SAVE_ROOT:-${BASE_OUT}/qcnet_topossm_decoder_corridor_score_seed49warm_h8_f12_s5_k6_4gpu_20260504}"
RUN_LOG="${RUN_LOG:-${LOG_DIR}/qcnet_topossm_decoder_corridor_score_seed49warm_h8_f12_s5_k6_4gpu_20260504.log}"
...
log "Corridor-score supervisor started"
