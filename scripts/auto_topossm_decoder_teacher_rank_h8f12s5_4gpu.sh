...
# Teacher-rank supervision for TopoSSM.
# Proposal stays free (goal MLP). The key change is explicit teacher top-1 / mode-ranking supervision on pi,
# plus moderate corridor and refine distillation.
...
SAVE_ROOT="${SAVE_ROOT:-${BASE_OUT}/qcnet_topossm_decoder_teacher_rank_seed49warm_h8_f12_s5_k6_4gpu_20260504}"
RUN_LOG="${RUN_LOG:-${LOG_DIR}/qcnet_topossm_decoder_teacher_rank_seed49warm_h8_f12_s5_k6_4gpu_20260504.log}"
...
log "Teacher-rank supervisor started"
