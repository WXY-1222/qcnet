...
# Clean PaperA mainline probe:
# - from scratch
# - no distillation
# - no extra auxiliary losses
# - only sweeps the mode_endpoint structural scale
...
STOP_IF_BEST_GT_E4="${STOP_IF_BEST_GT_E4:-0.0800}"
STOP_IF_BEST_GT_E8="${STOP_IF_BEST_GT_E8:-0.0680}"

SCALE_TAG="${TOPO_MODE_ENDPOINT_SCALE//./p}"
SAVE_ROOT="${SAVE_ROOT:-${BASE_OUT}/paperA_clean_scale${SCALE_TAG}_h8_f12_s5_k6_4gpu_seed${SEED}_${RUN_TAG}}"
RUN_LOG="${RUN_LOG:-${LOG_DIR}/paperA_clean_scale${SCALE_TAG}_h8_f12_s5_k6_4gpu_seed${SEED}_${RUN_TAG}.log}"
...
log "PaperA clean scale probe started"
