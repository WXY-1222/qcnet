...
SEED="${SEED:-17}"
RUN_TAG="${RUN_TAG:-20260506_paperA_v6_lite_fresh20_seed17}"
...
SAVE_ROOT="${SAVE_ROOT:-${BASE_OUT}/paperA_v6_lite_fresh20_h8_f12_s5_k6_4gpu_seed${SEED}_${RUN_TAG}}"
RUN_LOG="${RUN_LOG:-${LOG_DIR}/paperA_v6_lite_fresh20_h8_f12_s5_k6_4gpu_seed${SEED}_${RUN_TAG}.log}"
...
log "PaperA-v6 lite fresh 20-epoch run started"
