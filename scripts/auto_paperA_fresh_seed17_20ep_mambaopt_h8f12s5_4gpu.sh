...
# Clean optimizer probe:
# keep the PaperA mainline architecture/loss unchanged, but give Mamba core
# params a smaller LR and zero weight decay.
...
SEED="${SEED:-17}"
RUN_TAG="${RUN_TAG:-20260506_paperA_fresh_seed17_20ep_mambaopt}"
...
STOP_IF_BEST_GT_E4="${STOP_IF_BEST_GT_E4:-0.075}"

SAVE_ROOT="${SAVE_ROOT:-${BASE_OUT}/paperA_fresh_mambaopt_h8_f12_s5_k6_4gpu_seed${SEED}_${RUN_TAG}}"
RUN_LOG="${RUN_LOG:-${LOG_DIR}/paperA_fresh_mambaopt_h8_f12_s5_k6_4gpu_seed${SEED}_${RUN_TAG}.log}"
...
log "PaperA fresh seed17 20-epoch Mamba-optimizer probe started"
