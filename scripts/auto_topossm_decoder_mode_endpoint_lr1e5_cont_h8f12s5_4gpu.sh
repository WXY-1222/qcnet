...
# Low-LR continuation from the best mode-specific endpoint TopoSSM checkpoint.
# The goal is to nudge the structural mode-endpoint head below 0.0525 without
# increasing topology/distillation loss weights.
...
STOP_BAD_ADE="${STOP_BAD_ADE:-0.0555}"
STOP_LATEST_ADE="${STOP_LATEST_ADE:-0.0605}"
...
SAVE_ROOT="${SAVE_ROOT:-${BASE_OUT}/qcnet_topossm_decoder_mode_endpoint_lr1e5_cont_h8_f12_s5_k6_4gpu_20260505}"
RUN_LOG="${RUN_LOG:-${LOG_DIR}/qcnet_topossm_decoder_mode_endpoint_lr1e5_cont_h8_f12_s5_k6_4gpu_20260505.log}"
...
log "TopoSSM mode-endpoint lr1e-5 continuation started"
